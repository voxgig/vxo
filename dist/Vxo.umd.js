...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"151e76a0-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/TaskBox.vue?vue&type=template&id=d9447010&
var TaskBoxvue_type_template_id_d9447010_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-card',_vm._b({class:_vm.spec.classes},'v-card',_vm.spec.card,false),[(null!=_vm.spec.title)?_c('h3',{on:{"click":_vm.title_toggle}},[_vm._v(" "+_vm._s(_vm.spec.title)+" "),(_vm.spec.ux.title_count)?_c('span',[_vm._v("("+_vm._s(_vm.filtered_items.length)+")")]):_vm._e()]):_vm._e(),(_vm.list_visible)?_c('v-list',_vm._b({staticClass:"vxo-task-box-items"},'v-list',_vm.spec.list,false),[(_vm.spec.ux.headers)?_vm._t("header",[_c('v-list-item',{staticClass:"vxo-task-box-item-headers"},[_vm._l((_vm.headers),function(header,index){return _c('v-list-item-content',{key:index,staticClass:"vxo-task-box-item-field vxo-task-box-item-header"},[_vm._v(_vm._s(header.title))])}),(_vm.spec.ux.actions)?_c('v-spacer'):_vm._e()],2)]):_vm._e(),_c('draggable',{attrs:{"handle":".vxo-task-box-handle"},model:{value:(_vm.items),callback:function ($$v) {_vm.items=$$v},expression:"items"}},_vm._l((_vm.filtered_items),function(item){return (!item.$remove)?_c('v-list-item',{key:item.id},[(!_vm.has_custom_title)?_c('v-list-item-content',{staticClass:"vxo-task-box-item-title vxo-task-box-item-field"},[(_vm.spec.ux.state)?_c('v-icon',{staticStyle:{"max-width":"32px"},attrs:{"left":""},on:{"click":function($event){$event.stopPropagation();$event.preventDefault();return _vm.change_item_state(item)}}},[_vm._v(_vm._s(_vm.item_state_icon(item)))]):_vm._e(),(!item.$edit)?_c('span',{staticStyle:{"display":"inline-block","max-width":"90%"},on:{"click":function($event){return _vm.item_title_action($event,item)}}},[_vm._v(" "+_vm._s(item.title)+" ")]):_vm._e(),(item.$edit)?_c('v-text-field',{attrs:{"outlined":"","hide-details":""},on:{"keyup":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"enter",13,$event.key,"Enter")){ return null; }return _vm.item_title_save(item)}},model:{value:(item.title),callback:function ($$v) {_vm.$set(item, "title", $$v)},expression:"item.title"}}):_vm._e()],1):_vm._e(),_vm._l((_vm.field_list),function(field){return _c('v-list-item-content',{key:field.name,staticClass:"vxo-task-box-item-field",attrs:{"data-field-name":field.name},on:{"click":function($event){return _vm.act_item(item)}}},[(field.kind=='text')?_c('span',{style:(_vm.make_text_style(field))},[_vm._v(" "+_vm._s(item[field.name])+" ")]):_vm._e(),(field.kind=='custom')?_vm._t('custom.'+field.name,[_vm._v(" "+_vm._s(item[field.name])+" ")],{"item":item,"field":field}):_vm._e()],2)}),(_vm.spec.ux.actions)?_c('v-spacer'):_vm._e(),(_vm.spec.ux.actions)?_c('v-list-item-icon',[(!item.$edit)?_c('v-icon',{on:{"click":function($event){return _vm.remove_item(item)}}},[_vm._v(_vm._s(_vm.spec.icon.remove))]):_vm._e(),(!item.$edit)?_c('v-icon',{on:{"click":function($event){return _vm.edit_item(item)}}},[_vm._v(_vm._s(_vm.spec.icon.edit))]):_vm._e(),(item.$edit)?_c('v-icon',{on:{"click":function($event){return _vm.save_item(item)}}},[_vm._v(_vm._s(_vm.spec.icon.save))]):_vm._e(),(!item.$edit)?_c('v-icon',{staticClass:"vxo-task-box-handle"},[_vm._v(_vm._s(_vm.spec.icon.drag))]):_vm._e()],1):_vm._e()],2):_vm._e()}),1),(_vm.spec.ux.add_item)?_vm._t("footer",[_c('v-list-item',[_c('v-btn',{on:{"click":_vm.add_item}},[_vm._v(_vm._s(_vm.spec.text.add_item))])],1)],{"add_item":_vm.add_item}):_vm._e()],2):_vm._e(),_c('task-box-editor',{attrs:{"spec":_vm.spec,"task":_vm.edit_task},on:{"toggle_status":_vm.toggle_status,"update_field":_vm.update_field,"create_task":_vm.create_task},scopedSlots:_vm._u([_vm._l((_vm.spec.fields),function(field){return {key:_vm.edit_slot(field),fn:function(){return [_vm._t('edit.'+field.name,null,{"task":_vm.edit_task,"field":field,"spec":_vm.spec})]},proxy:true}})],null,true),model:{value:(_vm.edit),callback:function ($$v) {_vm.edit=$$v},expression:"edit"}})],1)}
var TaskBoxvue_type_template_id_d9447010_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/TaskBox.vue?vue&type=template&id=d9447010&
...
var TaskBox_component = normalizeComponent(
  ...
  TaskBoxvue_type_template_id_d9447010_render,
  TaskBoxvue_type_template_id_d9447010_staticRenderFns,
  false,
  null,
  null,
  null
