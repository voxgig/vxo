...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_SlideSelect_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TaskBox_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TaskBoxEditor_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"2b55bfbe-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Canary.vue?vue&type=template&id=79abbc37&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('v-label',[_vm._v("VXO-CANARY")])],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/Canary.vue?vue&type=template&id=79abbc37&
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"2b55bfbe-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/TaskBox.vue?vue&type=template&id=110de9cf&
var TaskBoxvue_type_template_id_110de9cf_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-card',_vm._b({class:_vm.spec.classes},'v-card',_vm.spec.card,false),[_c('v-toolbar',{attrs:{"flat":"","dense":""}},[(null!=_vm.spec.title)?_c('h3',{on:{"click":_vm.title_toggle}},[_vm._v(" "+_vm._s(_vm.spec.title)+" "),(_vm.spec.ux.title_count)?_c('span',[_vm._v("("+_vm._s(_vm.items.length)+")")]):_vm._e()]):_vm._e(),(_vm.spec.tool.add.active)?_c('v-spacer'):_vm._e(),(_vm.spec.tool.add.active)?_c('v-btn',_vm._b({on:{"click":function($event){$event.stopPropagation();$event.preventDefault();return _vm.add_item($event)}}},'v-btn',_vm.spec.tool.add.props,false),[_vm._v(" "+_vm._s(_vm.spec.tool.add.text)+" ")]):_vm._e()],1),(_vm.list_visible)?_c('v-list',_vm._b({staticClass:"vxo-task-box-items"},'v-list',_vm.spec.list,false),[(_vm.spec.ux.headers)?_vm._t("header",[_c('v-list-item',{staticClass:"vxo-task-box-item-headers"},[_vm._l((_vm.headers),function(header,index){return _c('v-list-item-content',{key:index,staticClass:"vxo-task-box-item-field vxo-task-box-item-header",style:(header.styling)},[_vm._v(_vm._s(header.title))])}),(_vm.spec.ux.actions)?_c('v-spacer'):_vm._e()],2)]):_vm._e(),_c('draggable',{attrs:{"handle":".vxo-task-box-handle"},model:{value:(_vm.items),callback:function ($$v) {_vm.items=$$v},expression:"items"}},_vm._l((_vm.items),function(item){return (!item.$remove)?_c('v-list-item',{key:item.id,class:_vm.list_item_classes(item)},[(!_vm.has_custom_title)?_c('v-list-item-content',{staticClass:"vxo-task-box-item-title vxo-task-box-item-field"},[(_vm.spec.ux.state && !item.$empty)?_c('v-icon',{staticStyle:{"max-width":"32px"},attrs:{"left":""},on:{"click":function($event){$event.stopPropagation();$event.preventDefault();return _vm.change_item_state(item)}}},[_vm._v(_vm._s(_vm.item_state_icon(item)))]):_vm._e(),(!item.$edit && !item.$empty)?_c('p',{on:{"click":function($event){return _vm.item_title_action($event,item)}}},[_vm._v(" "+_vm._s(item.title)+" ")]):_vm._e(),(item.$edit && !item.$empty)?_c('v-text-field',{ref:'item'+item.$index,refInFor:true,attrs:{"outlined":"","hide-details":""},on:{"keyup":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"enter",13,$event.key,"Enter")){ return null; }return _vm.item_title_save(item)}},model:{value:(item.title),callback:function ($$v) {_vm.$set(item, "title", $$v)},expression:"item.title"}}):_vm._e()],1):_vm._e(),_vm._l((_vm.field_list),function(field){return _c('v-list-item-content',{key:field.name,staticClass:"vxo-task-box-item-field",style:(field.styling),attrs:{"data-field-name":field.name},on:{"click":function($event){return _vm.act_item(item)}}},[(field.kind=='text')?_c('span',{style:(_vm.make_text_style(field))},[_vm._v(" "+_vm._s(item[field.name])+" ")]):_vm._e(),(field.kind=='custom')?_vm._t('custom.'+field.name,[_vm._v(" "+_vm._s(item[field.name])+" ")],{"item":item,"field":field}):_vm._e()],2)}),(_vm.spec.ux.actions)?_c('v-spacer'):_vm._e(),(_vm.spec.ux.actions)?_c('v-list-item-icon',[(!item.$edit)?_c('v-icon',{on:{"click":function($event){return _vm.remove_item(item)}}},[_vm._v(_vm._s(_vm.spec.icon.remove))]):_vm._e(),(!item.$edit)?_c('v-icon',{on:{"click":function($event){return _vm.edit_item(item)}}},[_vm._v(_vm._s(_vm.spec.icon.edit))]):_vm._e(),(item.$edit)?_c('v-icon',{on:{"click":function($event){return _vm.save_item(item)}}},[_vm._v(_vm._s(_vm.spec.icon.save))]):_vm._e(),(!item.$edit)?_c('v-icon',{staticClass:"vxo-task-box-handle"},[_vm._v(_vm._s(_vm.spec.icon.drag))]):_vm._e()],1):_vm._e()],2):_vm._e()}),1),(_vm.spec.ux.add_item)?_vm._t("footer",[_c('v-list-item',[_c('v-btn',{on:{"click":_vm.add_item}},[_vm._v(_vm._s(_vm.spec.text.add_item))])],1)],{"add_item":_vm.add_item}):_vm._e()],2):_vm._e(),_c('task-box-editor',{attrs:{"spec":_vm.spec,"task":_vm.edit_task},on:{"toggle_status":_vm.toggle_status,"update_field":_vm.update_field,"create_task":_vm.create_task},scopedSlots:_vm._u([_vm._l((_vm.spec.fields),function(field){return {key:_vm.edit_slot(field),fn:function(){return [_vm._t('edit.'+field.name,null,{"task":_vm.edit_task,"field":field,"spec":_vm.spec})]},proxy:true}})],null,true),model:{value:(_vm.edit),callback:function ($$v) {_vm.edit=$$v},expression:"edit"}})],1)}
var TaskBoxvue_type_template_id_110de9cf_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/TaskBox.vue?vue&type=template&id=110de9cf&
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"2b55bfbe-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/TaskBoxEditor.vue?vue&type=template&id=7181612d&
var TaskBoxEditorvue_type_template_id_7181612d_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-dialog',_vm._b({model:{value:(_vm.open),callback:function ($$v) {_vm.open=$$v},expression:"open"}},'v-dialog',_vm.spec.dialog,false),[_c('v-card',{staticClass:"vxo-task-box-editor"},[(_vm.spec.ux.toolbar)?_c('v-toolbar',{staticClass:"vxo-task-box-toolbar",attrs:{"dense":"","flat":""}},[(!_vm.item.$new)?_c('v-btn',{class:_vm.spec.ux.toolbar_btn_class,attrs:{"outlined":""},on:{"click":_vm.toggle_status}},[_vm._v(" "+_vm._s(_vm.spec.ux.toolbar_status_btn_text_map[_vm.item.state])+" ")]):_vm._e(),(_vm.item.$new)?_c('v-btn',{class:_vm.spec.ux.toolbar_btn_class,attrs:{"outlined":""},on:{"click":function($event){return _vm.create_task(_vm.item)}}},[_vm._v(" Create Task ")]):_vm._e(),_c('v-spacer'),_c('v-icon',{on:{"click":function($event){_vm.open=false}}},[_vm._v("mdi-close")])],1):_vm._e(),_c('ul',{staticClass:"vxo-task-box-editor-items"},_vm._l((_vm.fields),function(field){return _c('li',{key:field.index},[('done' === field.kind)?_c('div',{staticClass:"vxo-task-box-editor-item"},[(!_vm.item[field.name])?_c('v-icon',{on:{"click":function($event){_vm.item[field.name]=true}}},[_vm._v("mdi-checkbox-blank")]):_vm._e(),(_vm.item[field.name])?_c('v-icon',{on:{"click":function($event){_vm.item[field.name]=false}}},[_vm._v("mdi-checkbox-marked")]):_vm._e()],1):_vm._e(),('string' === field.kind)?_c('v-text-field',{staticClass:"vxo-task-box-editor-item",attrs:{"label":field.label,"data-field-name":field.name,"placeholder":"--"},on:{"change":function($event){return _vm.update_field(field,_vm.item)}},model:{value:(_vm.item[field.name]),callback:function ($$v) {_vm.$set(_vm.item, field.name, $$v)},expression:"item[field.name]"}}):_vm._e(),('custom' === field.kind)?_vm._t('edit.'+field.name,[_vm._v(" "+_vm._s(_vm.item[field.name])+" ")],{"task":_vm.item,"field":field,"spec":_vm.spec}):_vm._e(),(field.kind=='component')?_c(field.component,{tag:"component",staticClass:"vxo-task-box-editor-item",attrs:{"task":_vm.item,"field":field,"spec":_vm.spec},model:{value:(_vm.item[field.name]),callback:function ($$v) {_vm.$set(_vm.item, field.name, $$v)},expression:"item[field.name]"}}):_vm._e()],2)}),0)],1)],1)}
var TaskBoxEditorvue_type_template_id_7181612d_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/TaskBoxEditor.vue?vue&type=template&id=7181612d&
...
var TaskBoxEditor_component = normalizeComponent(
  ...
  TaskBoxEditorvue_type_template_id_7181612d_render,
  TaskBoxEditorvue_type_template_id_7181612d_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var TaskBoxvue_type_script_lang_js_ = ({
  ...
  watch: {
    ...
    'trigger.new_task': function triggerNew_task(new_task) {
      var new_item = TaskBoxvue_type_script_lang_js_clone(new_task);
  ...
  methods: {
    init: function init() {
      this.items = _toConsumableArray(this.value || []).map(function (item) {
        item = TaskBoxvue_type_script_lang_js_clone(item);
    ...
    close_items: function close_items() {
      var index = 0;
    ...
    update_items: function update_items() {
      ...
      if (this.spec.ux.open_rows) {
        var empty = this.items.find(function (x) {
          return x.$empty;
        });
        var adder = this.items.find(function (x) {
          return x.$adder;
        });
        var len = Math.max(this.spec.ux.open_rows, this.items.length + (null == empty && null == adder ? 1 : 0));

        while (this.items.length < len) {
          this.items.push(_objectSpread2(_objectSpread2({}, this.new_item()), {}, {
            $edit: false,
            $adder: false,
            $empty: true,
            title: ''
    ...
    create_task: function create_task(item) {
      delete item.$new;
      var new_item = TaskBoxvue_type_script_lang_js_clone(item);
      this.items = [].concat(_toConsumableArray(this.items), [new_item]);
    },
    item_title_action: function item_title_action(event, item) {
      ...
      if (this.spec.item.title_edit) {
        ...
        setTimeout(function () {
          ...
          var input_el = _this.$refs['item' + item.$index];
    ...
    list_item_classes: function list_item_classes(item) {
      return [item.$edit ? 'vxo-task-box-item-state-edit' : '', item.$adder ? 'vxo-task-box-item-state-adder' : '', item.$new ? 'vxo-task-box-item-state-new' : ''].join(' ');
    }
  }
});

function init_spec(spec) {
  spec.card = _objectSpread2({}, spec.card);
  spec.dialog = _objectSpread2({}, spec.dialog);
  spec.list = _objectSpread2({}, spec.list);
  spec.text = _objectSpread2({
    add_item: 'Add Item'
  }, spec.text);
  spec.item = _objectSpread2({
    title_edit: true
  }, spec.item);
  spec.icon = _objectSpread2({
    save: 'mdi-checkbox-marked',
    remove: 'mdi-close-box',
    drag: 'mdi-apps-box',
    edit: 'mdi-pencil-box'
  }, spec.icon);
  spec.icon.$state = _objectSpread2({
    done: 'mdi-check-circle-outline',
    todo: 'mdi-circle-outline'
  }, spec.icon.$state);
  spec.classes = _objectSpread2({
    'vxo-task-box': true
  }, spec.classes);
  spec.statemap = _objectSpread2({
    done: 'todo',
    todo: 'done'
  }, spec.statemap);
  spec.fields = _toConsumableArray(spec.fields || []);
  spec.tool = spec.tool || {};
  spec.tool.add = _objectSpread2({
    active: false,
    text: 'Add Item'
  }, spec.tool.add);
  spec.tool.add.props = _objectSpread2({}, spec.tool.add.props);
  spec.ux = _objectSpread2({
    state: true,
    actions: true,
    title_count: false,
    title_toggle: true,
  ...
  spec.custom = _objectSpread2({}, spec.custom);
}
...
var TaskBox_component = normalizeComponent(
  ...
  TaskBoxvue_type_template_id_110de9cf_render,
  TaskBoxvue_type_template_id_110de9cf_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"2b55bfbe-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/SlideSelect.vue?vue&type=template&id=59c795e8&
var SlideSelectvue_type_template_id_59c795e8_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"vxo-slide-select"},[_c('vueper-slides',{staticClass:"no-shadow",attrs:{"arrows-outside":"","slide-multiple":"","disable-arrows-on-edges":"","visible-slides":_vm.size,"bullets":false,"infinte":false,"touchable":false,"fixedHeight":_vm.styles.height,"initSlide":_vm.initial}},_vm._l((_vm.slides),function(item,index){return _c('vueper-slide',{key:index,class:_vm.slide_class(index),scopedSlots:_vm._u([{key:"content",fn:function(){return [_c('div',{on:{"click":function($event){return _vm.action_item(item,index)}}},[_vm._t("item",[_c('div',[_vm._v(_vm._s(item.text))])],{"item":item})],2)]},proxy:true}],null,true)})}),1)],1)}
var SlideSelectvue_type_template_id_59c795e8_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/SlideSelect.vue?vue&type=template&id=59c795e8&
...
/* harmony default export */ var SlideSelectvue_type_script_lang_js_ = ({
  ...
  created: function created() {
    if (this.range) {
      ...
      this.slides = Array.isArray(this.items) ? _toConsumableArray(this.items) : [];
    }
...
var SlideSelect_component = normalizeComponent(
  ...
  SlideSelectvue_type_template_id_59c795e8_render,
  SlideSelectvue_type_template_id_59c795e8_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"2b55bfbe-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Time.vue?vue&type=template&id=1d4d4548&
var Timevue_type_template_id_1d4d4548_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('span',{class:_vm.classes,style:(_vm.styling)},[_vm._v(_vm._s(_vm.start)+_vm._s('' != _vm.end ? '–'+_vm.end : ''))])}
var Timevue_type_template_id_1d4d4548_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/Time.vue?vue&type=template&id=1d4d4548&
...
var Time_component = normalizeComponent(
  ...
  Timevue_type_template_id_1d4d4548_render,
  Timevue_type_template_id_1d4d4548_staticRenderFns,
  false,
  null,
  null,
  null
...
//# sourceMappingURL=Vxo.umd.js.map